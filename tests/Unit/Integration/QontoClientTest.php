...
class QontoClientTest extends TestCase
{
    ...
    public function it_builds_the_incoming_invoices_url_with_query_filters(): void
    {
        ...
        self::assertSame(
            'https://thirdparty.qonto.com/v2/supplier_invoices?status=pending&page=2&filter%5Bsource%5D%5B%5D=e_invoicing&per_page=100',
    ...
    public function it_does_not_append_a_query_string_when_no_filters_are_given(): void
    {
        ...
        /* Assert */
        self::assertSame(
            'https://thirdparty.qonto.com/v2/supplier_invoices?filter%5Bsource%5D%5B%5D=e_invoicing&per_page=100',
            $http->requestLog[0]['url']
        );
    }
    ...
    #[Test]
    public function it_imports_the_pdf_even_when_invoice_payload_metadata_is_missing(): void
    {
        /* Arrange */
        $document        = $this->tempPdf();
        [$client, $http] = $this->makeClient([
    ...
    #[Test]
    public function it_fails_when_the_import_returns_no_client_invoice_id(): void
    {
        /* Arrange */
        $document        = $this->tempPdf();
        [$client, $http] = $this->makeClient([
    ...
    public function it_defaults_the_invoice_currency_to_eur_when_missing(): void
    {
        ...
        /* Assert */
        self::assertSame('INV-1', $metadata['invoice_number']);
    }
