...
class BckpTaskServiceTest extends AbstractTestCase
{
    ...
    private \Tests\Feature\Invoices\TaskService $service;
    ...
    public function it_returns_correct_model_class(): void
    {
        ...
        /* Assert */
        $this->assertEquals(\Tests\Feature\Invoices\Task::class, $modelClass);
    }
    ...
    public function it_creates_task(): void
    {
        ...
        /* Assert */
        $this->assertInstanceOf(\Tests\Feature\Invoices\Task::class, $task);
    ...
    public function it_finds_task_by_id(): void
    {
        ...
        /* Assert */
        $this->assertInstanceOf(\Tests\Feature\Invoices\Task::class, $found);
