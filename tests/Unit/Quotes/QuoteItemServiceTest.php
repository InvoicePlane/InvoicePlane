...
/**
 * Smoke test for the QuoteItemServiceTest module via CI3 HTTP harness.
 */
class QuoteItemServiceTest extends AbstractTestCase
{
    ...
    {
        /* Arrange */
        $clientId = $this->seedClient(['client_name' => 'Quote Item Service Client']);
        $quoteId  = $this->databaseInsert('ip_quotes', [
            ...
            'quote_number'       => 'QUO-ITEM-SVC-001',
            'quote_url_key'      => 'itemsvckey001',
        ]);
        ...
        /* Assert */
        $this->assertDatabaseHas('ip_quotes', ['quote_number' => 'QUO-ITEM-SVC-001']);
