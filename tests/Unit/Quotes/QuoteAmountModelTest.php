...
class QuoteAmountModelTest extends AbstractTestCase
{
    private $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->model      = new QuoteAmountService($this->quoteService);
    }
    ...
    public function it_calculates_global_discount(): void
    {
        ...
        /* Act */
        $globalDiscount = $this->model->getGlobalDiscount($quote->quote_id);
    ...
    public function it_calculates_discount_for_legacy_mode(): void
    {
        ...
        /* Act */
        $result = $this->model->calculateDiscount($quote->quote_id, $quoteTotal, $decimalPlaces);
    ...
    public function it_gets_total_quoted_for_all_time(): void
    {
        ...
        /* Act */
        $total = $this->model->getTotalQuoted();
    ...
    {
        $totals = $this->model->getStatusTotals('this-month');
