...
/**
 * Smoke test for the QuoteItemAmountServiceTest module via CI3 HTTP harness.
 */
class QuoteItemAmountServiceTest extends AbstractTestCase
{
    ...
    {
        /* Arrange */
        $clientId = $this->seedClient(['client_name' => 'Quote Amount Service Client']);
        $quoteId  = $this->databaseInsert('ip_quotes', [
            ...
            'quote_number'       => 'QUO-AMT-SVC-001',
            'quote_url_key'      => 'amtsvckey001',
        ]);
        ...
        /* Assert */
        $this->assertDatabaseHas('ip_quotes', ['quote_number' => 'QUO-AMT-SVC-001']);
