...
class QuoteItemModelTest extends AbstractTestCase
{
    private $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->model          = new QuoteItemService($quoteAmountService, $quoteItemAmountService);
    }
    ...
    public function it_saves_item(): void
    {
        ...
        /* Act */
        $item = $this->model->saveItem($itemData);
    ...
    public function it_gets_items_subtotal(): void
    {
        ...
        /* Act */
        $subtotal = $this->model->getItemsSubtotal($quote->quote_id);
