...
use Tests\Feature\Invoices\InvoiceService;

#[CoversClass(InvoiceAmountService::class)]

class InvoiceModelTest extends AbstractTestCase
{
    ...
    {
        $this->markTestIncomplete();
        $rules = $this->model->getSaveValidationRules(123);
    ...
    public function it_calculates_due_date_from_creation_date(): void
    {
        ...
        $dueDate = $this->model->calculateDateDue($createdDate);
    ...
    {
        $this->markTestIncomplete();
        $key1 = $this->model->generateUrlKey();
        $key2 = $this->model->generateUrlKey();
    ...
    public function it_gets_invoice_group_id(): void
    {
        ...
        $groupId = $this->model->getInvoiceGroupId($invoice->invoice_id);
    ...
    public function it_gets_parent_invoice_number(): void
    {
        ...
        $number = $this->model->getParentInvoiceNumber($parentInvoice->invoice_id);
    ...
    public function it_deletes_invoice_and_related_records(): void
    {
        ...
        $result = $this->model->deleteInvoice($invoice->invoice_id);
    ...
    public function it_marks_invoice_as_viewed_when_sent(): void
    {
        ...
        $result = $this->model->markViewed($invoice->invoice_id);
    ...
    public function it_marks_draft_invoice_as_sent(): void
    {
        ...
        $result = $this->model->markSent($invoice->invoice_id);
    ...
    public function it_detects_overdue_invoice(): void
    {
        ...
        $result = $this->model->isOverdue($invoice);
    ...
    public function it_calculates_days_overdue(): void
    {
        ...
        $result = $this->model->getDaysOverdue($invoice);
