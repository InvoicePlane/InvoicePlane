...
class InvoiceItemModelTest extends AbstractTestCase
{
    private $service;
    ...
    public function it_creates_new_item(): void
    {
        ...
        /* Act */
        $item = $this->model->saveItem(null, $data, $invoice->invoice_id);
    ...
    public function it_updates_existing_item(): void
    {
        ...
        /* Act */
        $item = $this->model->saveItem($existingItem->item_id, $data, $invoice->invoice_id);
    ...
    public function it_deletes_item_and_recalculates_invoice(): void
    {
        ...
        /* Act */
        $result = $this->model->deleteItem($item->item_id);
    ...
    public function it_returns_false_when_deleting_non_existent_item(): void
    {
        ...
        /* Act */
        $result = $this->model->deleteItem(99999);
    ...
    public function it_gets_items_subtotal(): void
    {
        ...
        /* Act */
        $subtotal = $this->model->getItemsSubtotal($invoice->invoice_id);
