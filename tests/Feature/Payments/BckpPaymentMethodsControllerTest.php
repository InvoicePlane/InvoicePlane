...
class BckpPaymentMethodsControllerTest extends AbstractTestCase
{
    ...
    public function it_updates_existing_payment_method(): void
    {
        ...
        $response = $this->post(\Tests\Feature\Invoices\route('payment_methods.form', ['id' => $method->payment_method_id]), $updateData);
    ...
    public function it_deletes_payment_method(): void
    {
        ...
        $response = $this->delete(\Tests\Feature\Invoices\route('payment_methods.delete', ['id' => $method->payment_method_id]));
