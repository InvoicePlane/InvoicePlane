...
@section('content')
    ...
    <h1 style="margin-bottom: 0;">{{ trans('ip.profit_and_loss') }}</h1>
    ...
    <table class="alternate">
        ...
        <tbody>
        <tr>
            <td style="font-weight: bold;">{{ trans('ip.income') }}</td>
            <td class="amount" style="font-weight: bold;">{{ $results['income'] }}</td>
        </tr>
        <tr>
            <td style="font-weight: bold;">{{ trans('ip.expenses') }}</td>
            <td></td>
        </tr>
        ...
        @endforeach
        <tr>
            <td style="font-weight: bold;">{{ trans('ip.total_expenses') }}</td>
            <td class="amount" style="font-weight: bold;">{{ $results['total_expenses'] }}</td>
        </tr>
        <tr>
            <td style="font-weight: bold;">{{ trans('ip.net_income') }}</td>
