...
<section class="content-header">
    <h1 class="pull-left">{{ trans('ip.recurring_invoice') }} #{{ $recurringInvoice->id }}</h1>
        ...
        <div class="col-lg-2">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>{{ trans('ip.stop_date') }}</label>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-sm" id="btn-update-exchange-rate" type="button"
                                        ...
                                        title="{{ trans('ip.update_exchange_rate') }}">
