...
<div class="row">
    <div class="col-md-4" id="col-client-name">
        <div class="form-group">
            <label>* {{ trans('ip.client_name') }}:</label>
            {!! Form::text('name', null, ['id' => 'name', 'class' => 'form-control']) !!}
            <p class="help-block">
                <small>{{ trans('ip.help_text_client_name') }}
                    <a href="javascript:void(0)" id="btn-show-unique-name"
                       tabindex="-1">{{ trans('ip.view_unique_name') }}</a>
                </small>
            </p>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('ip.phone_number') }}: </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('ip.fax_number') }}: </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('ip.mobile_number') }}: </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('ip.web_address') }}: </label>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('ip.default_currency') }}: </label>
