...
| CSRF: `generate_pdf` marks a draft invoice sent and assigns its number via GET | Medium | — | [@ashrexon](https://github.com/ashrexon) | [#1674](https://github.com/InvoicePlane/InvoicePlane/pull/1674) |
