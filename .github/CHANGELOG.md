...
- **IDOR in Users::change_password()**: Restricted password changes to the requester's own account; previously any admin could change any other admin's password — including the primary administrator — via a direct POST, enabling account takeover. [[GHSA-TODO]: TODO](TODO) (High) — reported by [@TODO](TODO).
