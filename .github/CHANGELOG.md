...
| Stored XSS via unescaped `invoice_number` and `quote_number` | Medium | [Stored XSS via unescaped invoice_number and quote_number in admin panel views and public templates](https://github.com/InvoicePlane/InvoicePlane/security/advisories/GHSA-pf36-9ww2-g2gr) | [@de3erve-hunter](https://github.com/de3erve-hunter) | — |
| Stored XSS via unescaped VAT / Tax-Code fields | Medium | [Stored XSS via unescaped VAT/Tax-Code fields in public invoice and quote web templates](https://github.com/InvoicePlane/InvoicePlane/security/advisories/GHSA-59hc-4457-ww33) | [@de3erve-hunter](https://github.com/de3erve-hunter) | — |
