...
- **Backend**: PHP 8.2, 8.3, and 8.4 (CodeIgniter 3.x framework)
...
- Use **type hints** where possible (PHP 8.2+ features)
...
- **PHP 8.2+ Compatible**: Ensure all code works with PHP 8.2, 8.3, and 8.4
