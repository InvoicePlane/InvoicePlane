...
$lang = [
    ...
    'recurring_generate_if_unpaid'                  => 'Continue generating even if previous invoice is unpaid',
    'recurring_generate_if_unpaid_tooltip'          => 'When checked, invoices will be generated on schedule regardless of payment status. When unchecked, generation will pause until all previous invoices are paid. Note: Draft invoices (status 1) with an outstanding balance will also block further generation until paid or deleted.',
    'recurring_generation_behavior'                 => 'Generation Behavior',
    'recurring_generation_continuous'               => 'Continuous',
    'recurring_generation_requires_payment'         => 'Requires Payment',
    'reject'                                        => 'Reject',
