...
$lang = [
    ...
    'custom_templates_upgrade_required_message' => 'One or more saved template settings use custom template names that are not in the explicit allowlist.',
    'custom_templates_upgrade_required_ipconfig' => 'Add the template names to the matching ipconfig.php allowlist key and configure CUSTOM_TEMPLATES_FOLDER when the files live outside the built-in template directory.',
    'custom_templates_upgrade_required_docs' => 'Only explicitly allowlisted custom templates are shown or rendered.',
