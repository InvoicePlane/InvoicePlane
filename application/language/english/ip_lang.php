...
$lang['identifier_format_template_tags_instructions'] = 'First select the "Identifier formatting" text field, then click on a template tag below to insert the tag into the field.';
