...
$lang = [
    ...
    'oidc_provider_url_hint'         => 'The OIDC provider URL (issuer). For Keycloak, this is typically https://your-keycloak.com/realms/your-realm',
    'oidc_client_id'                 => 'Client ID',
    'oidc_client_secret'             => 'Client Secret',
    'oidc_client_secret_hint'        => 'Leave empty to keep the current secret. The secret is stored encrypted.',
    'oidc_scopes'                    => 'Scopes',
    'oidc_scopes_hint'               => 'Space-separated list of scopes to request. Default: openid email profile',
    'oidc_user_settings'             => 'User Settings',
    'oidc_auto_create_users'         => 'Auto-create users',
    'oidc_auto_create_users_hint'    => 'Automatically create new user accounts when users log in via SSO for the first time.',
    'oidc_default_user_type'         => 'Default user role',
    'oidc_default_user_type_hint'    => 'The role assigned to automatically created users.',
    'oidc_allow_local_login'         => 'Allow local password login',
    'oidc_allow_local_login_hint'    => 'When disabled, users can only log in via SSO. Useful for enforcing SSO-only authentication.',
    'oidc_auto_redirect_login'       => 'Skip login screen/button for authenticated users',
    'oidc_auto_redirect_login_hint'  => 'When enabled, InvoicePlane starts SSO immediately instead of showing the login page. Users already signed in to the identity provider are logged in automatically; other users are redirected to the identity provider to sign in. Use /sessions/login?local=1 to reach the local login page for testing or recovery.',
    'oidc_require_email_verified'    => 'Require verified email for linking',
    'oidc_require_email_verified_hint' => 'When enabled, InvoicePlane will only link existing accounts by email if the identity provider marks the email as verified.',
    'oidc_advanced_settings'         => 'Advanced Settings',
    'oidc_verify_ssl'                => 'Verify SSL certificates',
    'oidc_verify_ssl_hint'           => 'Disable only for development environments with self-signed certificates.',
    'oidc_button_text'               => 'SSO Button Text',
    'oidc_button_text_hint'          => 'Custom text for the SSO login button. Leave empty for default.',
    'oidc_token_auth_methods'        => 'Token endpoint auth methods',
    'oidc_token_auth_methods_hint'   => 'Comma-separated list. Common values: client_secret_post, client_secret_basic.',
    'oidc_idp_examples'              => 'Identity Provider Examples',
    'oidc_idp_provider'              => 'Provider',
    'oidc_idp_provider_hint'         => 'Select a provider to see example settings.',
    'oidc_idp_authelia'              => 'Authelia',
    'oidc_idp_authentik'             => 'Authentik',
    'oidc_idp_keycloak'              => 'Keycloak',
    'oidc_idp_azure'                 => 'Azure AD',
    'oidc_idp_okta'                  => 'Okta',
    'oidc_idp_google'                => 'Google',
    'oidc_idp_auth0'                 => 'Auth0',
    'oidc_idp_onelogin'              => 'OneLogin',
    'oidc_idp_zitadel'               => 'Zitadel',
    'oidc_idp_examples_note'         => 'These are example values. Use the issuer URL and settings from your provider.',
    'oidc_copy_example'              => 'Copy Example',
    'oidc_copied'                    => 'Copied',
    'oidc_redirect_uri'              => 'Redirect URI',
    'oidc_redirect_uri_hint'         => 'Configure this URL as the redirect/callback URI in your identity provider.',
    'oidc_login'                     => 'Login with SSO',
    'oidc_error_not_configured'      => 'OIDC SSO is not properly configured. Please contact the administrator.',
    'oidc_error_auth_failed'         => 'Authentication failed. Please try again or contact the administrator.',
    'oidc_error_user_not_found'      => 'No account found for this SSO user. Please contact the administrator.',
    'oidc_error_user_inactive'       => 'Your account is inactive. Please contact the administrator.',
