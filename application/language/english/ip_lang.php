...
$lang = [
    ...
    'recurring_generate_if_unpaid_tooltip'          => 'When checked, invoices will be generated on schedule regardless of payment status. When unchecked, generation will pause until all previous invoices are paid, including draft invoices with an outstanding balance.',
