...
$lang = [
    ...
    'generate_recurring_if_unpaid'                 => 'Generate Recurring Invoices With Outstanding Balance',
    'generate_recurring_if_unpaid_help'            => 'When enabled, recurring invoices will be generated on schedule regardless of outstanding invoices. When disabled, the system will wait for all invoices to be paid before generating the next recurring invoice.',
