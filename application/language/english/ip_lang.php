...
$lang = [
    ...
    'invoice_reminders_enabled_hint'    => 'When you first switch this on, each eligible invoice that has already reached one of the days above receives one catch-up reminder on the next cron run. Eligible means sent or viewed, with a balance owing, not opted out, and with a reminder template available.',
