...
Link to Quote: %4$s',
    ...
    'setup_v120_alert' => '<b>Please read carefully!</b><br/>It is not possible to delete sent invoices anymore. We disabled the feature because it\'s forbidden by law in many countries.<br/>But we want to introduce credit invoices to you which will help you if you made a mistake.<br/>If you want to learn more about this and how to re-enable the invoice deletion please take a look at <a href="https://go.invoiceplane.com/v120update" target="_blank">this news post</a>.',
