...
ALTER TABLE `ip_invoice_groups` CHANGE `invoice_group_left_pad` `invoice_group_left_pad` INT( 2 ) NOT NULL DEFAULT '0';
...
ALTER TABLE `ip_quotes` CHANGE `invoice_id` `invoice_id` INT( 11 ) NOT NULL DEFAULT '0';

ALTER TABLE `ip_quote_amounts` CHANGE `quote_total` `quote_total` DECIMAL( 10, 2 ) NOT NULL DEFAULT '0.00';

ALTER TABLE `ip_quote_items` CHANGE `item_order` `item_order` INT( 2 ) NOT NULL DEFAULT '0';

ALTER TABLE `ip_invoice_items` CHANGE `item_order` `item_order` INT( 2 ) NOT NULL DEFAULT '0',
CHANGE `item_tax_rate_id` `item_tax_rate_id` INT( 11 ) NOT NULL DEFAULT '0';

ALTER TABLE `ip_payments` CHANGE `payment_method_id` `payment_method_id` INT( 11 ) NOT NULL DEFAULT '0';