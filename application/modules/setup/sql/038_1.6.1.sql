...
ALTER TABLE `ip_quotes` ADD quote_work_order VARCHAR(30) NULL DEFAULT NULL AFTER `quote_id`;
ALTER TABLE `ip_quotes` ADD quote_agreement VARCHAR(30) NULL DEFAULT NULL AFTER `quote_work_order`;
