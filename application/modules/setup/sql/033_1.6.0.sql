...
ALTER TABLE `ip_invoice_item_amounts` ADD `item_subtotal_discounted` DECIMAL(20,2) NULL;
ALTER TABLE `ip_quote_item_amounts` ADD `item_subtotal_discounted` DECIMAL(20,2) NULL;
