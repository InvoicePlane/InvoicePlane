...
ALTER TABLE `ip_users`
  ADD COLUMN user_bank TEXT DEFAULT NULL AFTER `user_subscribernumber`,
  ...
  ADD COLUMN user_invoicing_contact TEXT DEFAULT NULL AFTER `user_country`;

ALTER TABLE `ip_clients`
  ADD COLUMN client_invoicing_contact TEXT DEFAULT NULL,
  ADD COLUMN client_einvoice_version TEXT DEFAULT NULL; 
