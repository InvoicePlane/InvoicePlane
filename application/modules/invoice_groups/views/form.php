<form method="post">
    ...
    <div id="headerbar">
        <h1 class="headerbar-title"><?php echo trans('invoice_group_form'); ?></h1>
            ...
            <div class="col-xs-12 col-md-6 col-md-offset-3">
                ...
                <div class="form-group">
                    <label class="control-label" for="invoice_group_identifier_format">
                        <?php echo trans('identifier_format'); ?>
                    </label>
                ...
                <div class="form-group no-margin">
                    ...
                    <label for="tags_client"><?php echo trans('identifier_format_template_tags'); ?></label>

                    <p class="small"><?php echo trans('identifier_format_template_tags_instructions'); ?></p>
                    ...
                    <select id="tags_client" class="tag-select form-control">
                        ...
                        <option value="{{{year}}}">
                            <?php echo trans('current_year'); ?>
                        </option>
                        <option value="{{{yy}}}">
                            <?php echo trans('current_yy'); ?>
                        </option>
                        <option value="{{{month}}}">
                            <?php echo trans('current_month'); ?>
                        </option>
                        <option value="{{{day}}}">
                            <?php echo trans('current_day'); ?>
                        </option>
                    </select>
