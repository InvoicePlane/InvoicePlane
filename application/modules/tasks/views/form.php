    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="task_price"><?php echo trans('task_price'); ?></label>
                        ...
                        <div class="form-group">
                            <label for="tax_rate_id"><?php echo trans('tax_rate'); ?></label>
                        ...
                        <div class="form-group">
                            <label for="task_status"><?php echo trans('status'); ?></label>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php echo trans('extra_information'); ?>
                    </div>
                    <div class="panel-body">

                        <div class="form-group">
                            <label for="project_id"><?php echo trans('project'); ?>: </label>
