...
class Mdl_Invoices extends Response_Model
{
    ...
    public function is_paid()
    {
        ...
        // (CWE-639/862, e.g. guest invoice listing scoped by client_id).
        // filter_group_start()/filter_group_end() defer the grouping into the
        // same queue so it wraps the two conditions as intended.
