            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <label for="settings[pdf_invoice_template_partial]">
                                <?php _trans('pdf_template_partial'); ?>
                            </label>
                            <select name="settings[pdf_invoice_template_partial]" class="form-control simple-select"
                                id="settings[pdf_invoice_template_partial]" data-minimum-results-for-search="Infinity">
                                <option value=""><?php _trans('none'); ?></option>
                                <?php foreach ($pdf_invoice_templates as $invoice_template) { ?>
                                    <option value="<?php echo $invoice_template; ?>"
                                        <?php check_select(get_setting('pdf_invoice_template_partial'), $invoice_template); ?>>
                                        <?php echo $invoice_template; ?>
                                    </option>
                                <?php } ?>
                            </select>
