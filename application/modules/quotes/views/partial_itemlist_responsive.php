						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-11">
								<div class="input-group">
									...
									<input type="text" name="item_name" id="item_name_<?=$item->item_id;?>" class="input-sm form-control" value="<?=_htmlsc($item->item_name);?>">
								</div>
								<div class="input-group">
									<label for="item_description_<?=$item->item_id;?>" class="input-group-addon ig-addon-aligned"><?php _trans('description'); ?></label>
									<textarea name="item_description" id="item_description_<?=$item->item_id;?>" class="input-sm form-control h135rem"><?=htmlsc($item->item_description);?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xs-12 col-lg-6">
								<div class="input-group">
									...
									<input type="text" name="item_quantity" id="item_quantity_<?=$item->item_id;?>" class="input-sm form-control" value="<?=format_amount($item->item_quantity);?>" >
								</div>
								<div class="input-group">
										<label for="item_product_unit_id_<?=$item->item_id;?>" class="input-group-addon ig-addon-aligned"><?php _trans('product_unit'); ?></label>
										<select name="item_product_unit_id" id="item_product_unit_id_<?=$item->item_id;?>" class="form-control input-sm">
												<option value="0"><?php _trans('none'); ?></option>
												<?php foreach ($units as $unit) { ?>
														<option value="<?=$unit->unit_id;?>"
								...
								<div class="input-group">
										...
										<input type="text" name="item_price" id="item_price_<?=$item->item_id;?>" class="input-sm form-control amount"
								...
								<div class="input-group">
										...
										<select name="item_tax_rate_id" id="item_tax_rate_id_<?=$item->item_id;?>" class="form-control input-sm">
												<option value="0"><?php _trans('none'); ?></option>
												<?php foreach ($tax_rates as $tax_rate) { ?>
														<option value="<?=$tax_rate->tax_rate_id; ?>"
