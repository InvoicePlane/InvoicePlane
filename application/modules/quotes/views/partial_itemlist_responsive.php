					...
					<div class="col-xs-12 col-sm-7 col-md-6 col-lg-5">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-11">
								...
								<div class="input-group">
									<label for="item_description" class="input-group-addon"><?php _trans('description'); ?></label>
									<textarea name="item_description" class="input-sm form-control"><?=htmlsc($item->item_description);?></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-5 col-md-6 col-lg-7">
						<div class="row">
							<div class="col-xs-12 col-md-6">
								<div class="input-group">
									<label for="item_quantity" class="input-group-addon"><?php _trans('quantity'); ?></label>
									<input type="text" name="item_quantity" class="input-sm form-control amount" value="<?=format_amount($item->item_quantity);?>" >
								</div>
								<div class="input-group">
										<label for="item_product_unit_id" class="input-group-addon"><?php _trans('product_unit'); ?></label>
