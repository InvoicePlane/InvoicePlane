<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).ready(function () {
            var discount_amount = $('#quote_discount_amount'),
                discount_percent = $('#quote_discount_percent');

            if (discount_percent.val().length > 0) {
                discount_amount.prop('disabled', true);
            }

            if (discount_amount.val().length > 0) {
...
<form action="<?php echo site_url('quotes/save'); ?>" method="post">
    ...
    <div id="headerbar">
        ...
        <div class="pull-right btn-group">
            ...
            <button type="submit" href="#" class="btn btn-sm btn-success ajax-loader" id="btn_save_quote">
                    ...
                    <div class="col-xs-12 col-md-5">
                        <div class="pull-left">
                            ...
                            <?php if ($quote->client_phone) { ?>
                                <div class="inline"><strong><?php echo lang('phone'); ?>
                                        :</strong> <?php echo $quote->client_phone; ?></div><br>
                            <?php } ?>
                            <?php if ($quote->client_email) { ?>
                                <span class="inline"><strong><?php echo lang('email'); ?>
                                    ...
                                    <div class="quote-properties">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="quote_number" name="quote_number"
                                                   ...
                                                   value="<?php echo old('quote_number', $quote->quote_number); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="quote-properties has-feedback">
                                        ...
                                        <div class="input-group">
                                            <input name="quote_date_created" id="quote_date_created"
                                                   ...
                                                   value="<?php echo date_from_mysql(old('quote_date_created', $quote->quote_date_created)); ?>">
                                    ...
                                    <div class="quote-properties has-feedback">
                                        ...
                                        <div class="input-group">
                                            <input name="quote_date_expires" id="quote_date_expires"
                                                   class="form-control input-sm datepicker"
                                                   value="<?php echo date_from_mysql(old('quote_date_expires', $quote->quote_date_expires)); ?>">
		                              <span class="input-group-addon">
		                                  <i class="fa fa-calendar fa-fw"></i>
		                              </span>
                                        </div>
                                        ...
                                        <select name="quote_status_id" id="quote_status_id"
                                            ...
                                            <?php foreach ($quote_statuses as $key => $status) { ?>
                                                <option value="<?php echo $key; ?>"
                                                    <?php if ($key == old('quote_status_id', $quote->quote_status_id)) { ?>
                                                        selected="selected"
                                                    <?php } ?>>
                                    ...
                                    <div class="quote-properties">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="quote_password" class="form-control input-sm"
                                                   name="quote_password"
                                                   value="<?php echo old('quote_password', $quote->quote_password); ?>">
                                        </div>
                                    </div>
            ...
            <?php if ($custom_fields) { ?>
                ...
                <?php foreach ($custom_fields as $custom_field) { ?>
                    ...
                    <input type="text" class="form-control"
                           ...
                           value="<?php
                           if (old('custom[' . $custom_field->custom_field_column . ']')) {
                               echo form_prep(old('custom[' . $custom_field->custom_field_column . ']'));
                           } else {
                               echo $this->mdl_quotes->form_value('custom[' . $custom_field->custom_field_column . ']');
                           }
                           ?>">
                <?php }
            } ?>
