            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6">
                ...
                <div class="quote-properties has-feedback">
                  ...
                  <div class="input-group">
                    <input name="quote_date_expires" id="quote_date_expires" class="form-control input-sm datepicker" value="<?php echo date_from_mysql($quote->quote_date_expires); ?>">
                    <span class="input-group-addon">
              ...
              <div class="quote-properties">
                ...
                <div class="controls">
                  <input type="text" id="quote_password" class="form-control input-sm" value="<?php echo $quote->quote_password; ?>">
                </div>
              </div>
            </div>
          </div>
