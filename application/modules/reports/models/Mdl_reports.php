...
class Mdl_Reports extends CI_Model
{
	...
	public function yearly()
    {
		...
		//the calculation here is the total expense amount, divided by the tax rate percentage. ie, if tax rate =10%, then this divides expense mount by 11 (that is (100 + 10%)/100). That gives the correct taxable amount
