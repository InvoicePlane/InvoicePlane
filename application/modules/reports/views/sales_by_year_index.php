<div class="headerbar">
	<h1><?php echo lang('sales_by_year'); ?></h1>
</div>
		...
		<div class="panel-body">
            ...
            <div class="form-group has-feedback" >
                    <label for="IVA">
					                 ...
					                 <div>
					                 <input type="checkbox" id="checkboxIVA" name="checkboxIVA"> <?php echo lang('valuesWithIVA');?>
					                 </div>
