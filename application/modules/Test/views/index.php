<style>.bs-component{margin: 1rem 0;}</style>
                    ...
                    <form>
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input readonly="" class="form-control-plaintext" id="staticEmail"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp"
                                       type="file">
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" name="optionsRadios" id="optionsRadios1"
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" name="optionsRadios" id="optionsRadios2"
                                ...
                                <div class="form-check disabled">
                                    <label class="form-check-label">
                                        <input class="form-check-input" name="optionsRadios" id="optionsRadios3"
            ...
            <div class="col-lg-4 offset-lg-1">
                ...
                <form class="bs-component">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg" placeholder=".form-control-lg" id="inputLarge"
                               type="text">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" placeholder=".form-control-sm" id="inputSmall"
                               type="text">
                    </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input id="customRadio1" name="customRadio" class="custom-control-input" checked=""
                                       type="radio">
                            ...
                            <div class="custom-control custom-radio">
                                <input id="customRadio3" name="customRadio" class="custom-control-input" disabled=""
                                       type="radio">
    ...
    <div class="bs-docs-section">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2>Modals</h2>
                <div class="bs-component">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ip-modal">
                        Show Modal
                    </button>
                    <div class="modal fade" id="ip-modal">
