...
class StorecoveClient implements IntegrationClientInterface
{
    ...
    public static function clientCode(): string { return 'storecove'; }

    public static function clientName(): string { return 'Storecove Netherlands (Peppol)'; }

    public static function authType(): string { return 'bearer'; }
    ...
    public function fetchToken(array $settings): string { return (string) ($settings['api_key'] ?? ''); }
    ...
    private function routing(array $metadata): array
    {
        ...
        if ((string) $scheme === '' || (string) $id === '') return [];
    ...
    private function setting(string $key): string { return (string) ($this->settings[$key] ?? ''); }
}
