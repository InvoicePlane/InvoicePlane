...
<div id="content">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body no-padding">
            ...
            <?php if ($overdue_invoices) { ?>
                <?php echo $this->layout->load_view('guest/partial_invoices_table', ['invoices' => $overdue_invoices]); ?>
            <?php } else { ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body no-padding">
            <?php echo $this->layout->load_view('guest/partial_invoices_table', ['invoices' => $open_invoices]); ?>
        </div>
