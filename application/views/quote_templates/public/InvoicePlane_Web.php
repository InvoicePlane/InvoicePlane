                ...
                <div class="col-xs-12 col-md-6 col-lg-5">
                    ...
                    <p>
                        ...
                        if ($quote->user_city || $quote->user_state || $quote->user_zip) {
                            if (is_zip_before_city($quote->user_country)) {
                                echo $quote->user_zip ? htmlsc($quote->user_zip) . ' ' : '';
                                echo $quote->user_city ? htmlsc($quote->user_city) . ' ' : '';
                            } else {
                                echo $quote->user_city ? htmlsc($quote->user_city) . ' ' : '';
                                echo $quote->user_zip ? htmlsc($quote->user_zip) . ' ' : '';
                            }
                ...
                <div class="col-xs-12 col-md-6 col-lg-5 text-right">
                    ...
                    <p>
                        ...
                        if ($quote->client_city || $quote->client_state || $quote->client_zip) {
                            if (is_zip_before_city($quote->client_country)) {
                                // Europäisch: PLZ Ort
                                echo $quote->client_zip ? htmlsc($quote->client_zip) . ' ' : '';
                                echo $quote->client_city ? htmlsc($quote->client_city) . ' ' : '';
                            } else {
                                // International: Ort PLZ
                                echo $quote->client_city ? htmlsc($quote->client_city) . ' ' : '';
                                echo $quote->client_zip ? htmlsc($quote->client_zip) . ' ' : '';
                            }
