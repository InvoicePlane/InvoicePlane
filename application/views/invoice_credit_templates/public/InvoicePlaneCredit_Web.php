...
<head>
    ...
    <title>
        ...
        - <?php echo trans('credit_invoice'); ?> <?php echo $invoice->invoice_number; ?>
    </title>
...
<div class="container">
    <div id="content">
        ...
        <div class="webpreview-header">
            ...
            <h2><?php echo trans('credit_invoice'); ?>&nbsp;<?php echo $invoice->invoice_number; ?></h2>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 col-lg-5 text-right">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <td><?php echo trans('original_invoice'); ?></td>
                            <td style="text-align:right;"><?php echo _htmlsc($invoice->parent_number); ?></td>
                        </tr>
                        <tr class="<?php echo($is_overdue ? 'overdue' : '') ?>">
