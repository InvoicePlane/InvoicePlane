...
<head>
    <meta charset="utf-8">
    <title><?php _trans('credit_invoice'); ?></title>
    <link rel="stylesheet"
...
<main>
    ...
    <div class="invoice-details clearfix">
        <table>
            ...
            <tr>
                ...
                <td><?php echo _htmlsc($invoice->parent_number, true); ?></td>
            </tr>
            <tr>
    ...
    <h1 class="invoice-title text-green"><?php echo trans('credit_invoice') . ' ' . $invoice->invoice_number; ?></h1>
