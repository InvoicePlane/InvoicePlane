            ...
            <div id="content">
                    ...
                    <tr>
                        ...
                        <td class="w-4 pt-3">
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    <td class="text-bold bt py-1 px-1 text-red"><?php echo trans('due_date') . ': '; ?></td>
                                    <td class="text-right bt py-1 px-1 text-red"><?php echo date_from_mysql($invoice->invoice_date_due, true); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-bold bt py-1 px-1 text-red"><?php echo trans('amount_due') . ': '; ?></td>
                                    <td class="text-right bt py-1 px-1 text-red"><?php echo format_currency($invoice->invoice_balance); ?></td>
                                </tr>
                ...
                <table class="w-10 table item-table mt-5 bt">
                    ...
                    <tbody class="invoice-sums">
                        ...
                        <tr>
                            <td <?php echo($show_item_discounts ? 'colspan="5"' : 'colspan="4"'); ?> class="text-right py-2 px-1 bt text-red">
                                <b><?php _trans('balance'); ?></b>
                            </td>
                            <td class="text-right py-2 px-1 bt text-red">
