    ...
    <div class="invoice-details clearfix">
        <table>
            ...
            <tr>
                ...
                <td class="text-red"><?php echo date_from_mysql(_htmlsc($invoice->invoice_date_due), true); ?></td>
            </tr>
            <tr>
                <td class="text-red"><?php echo trans('amount_due') . ': '; ?></td>
                <td class="text-red"><?php echo format_currency(_htmlsc($invoice->invoice_balance)); ?></td>
            </tr>
    ...
    <table class="item-table">
        ...
        foreach ($items as $item) { ?>
            <tr>
                ...
                <td class="text-right">
                    <?php echo format_amount(_htmlsc($item->item_quantity)); ?>
