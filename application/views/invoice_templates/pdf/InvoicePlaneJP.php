...
<header class="clearfix">
    ...
    <div id="company">
        ...
        echo '</div>';
        echo '<div>';
        if ($invoice->user_custom_inkan_filename) {
          if ($invoice->user_custom_pic) {
            echo $invoice->user_custom_pic;
          }
          echo '<img src="' . base_url() . 'uploads/' . $invoice->user_custom_inkan_filename . '" width="35", height="35" alt="inkan" style="position:absolute;">';
        }
        echo '</div>';
