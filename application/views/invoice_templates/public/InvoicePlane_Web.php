...
<html lang="<?php _trans('cldr'); ?>">
    <head>
        ...
        <title>
            <?php echo get_setting('custom_title', 'InvoicePlane', true); ?> - <?php _trans('invoice'); ?> <?php echo
            htmlsc($invoice->invoice_number); ?>
        </title>
            ...
            <div id="content">
                <div class="webpreview-header">
                    ...
                    <div class="btn-group">
                        ...
                        <a
                            href="<?php echo site_url($_SESSION['user_type'] > 1 ? 'guest' : ''); ?>"
                            class="btn btn-default"
                            title="<?php _trans('dashboard'); ?>"
                        >
                            <i class="fa fa-dashboard"></i> <?php _trans('dashboard'); ?>
                        </a>
                        <?php } ?>
                        <a
                            href="<?php echo site_url('guest/view/generate_' . ($invoice->sumex_id == null ? 'invoice' : 'sumex') . '_pdf/' . $invoice_url_key); ?>"
                        ...
                        <a
                            href="<?php echo site_url('guest/payment_information/form/' . $invoice_url_key); ?>"
                ...
                <div class="invoice">
                    <?php $logo = invoice_logo(); if ($logo) { echo $logo . '<br /><br />'; } ?>
                    <div class="row">
                    ...
                    <div class="invoice-items">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="amount">
                                            <?php echo format_quantity($item->item_quantity); ?> <?php if
                                    ...
                                    <?php } // End foreach ?> <?php $colspan = $show_item_discounts ? 4 : 3; if
                                    ($invoice?->invoice_discount_percent > 0 || $invoice?->invoice_discount_amount > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="amount">
                                            <?php
                                        if ($invoice->invoice_discount_percent > 0) { echo
                                            format_amount($invoice->invoice_discount_percent) . '&nbsp;%'; } else { echo
                                    ...
                                    <?php } ?> <?php foreach ($invoice_tax_rates as $invoice_tax_rate) { ?>
                                    <tr>
                                        <td class="no-bottom-border" colspan="<?php echo $colspan; ?>"></td>
                                        <td class="amount">
                                    ...
                                    <?php } ?> <?php if ($invoice?->invoice_discount_percent > 0 ||
                                    $invoice?->invoice_discount_amount > 0) { if ($legacy_calculation) { ?>
                                    <tr>
                                    ...
                                    <tr
                                        class="<?php echo ($invoice->invoice_balance > 0) ? 'overdue' : 'text-success'; ?>"
                                    >
                                        <td class="no-bottom-border" colspan="<?php echo $colspan; ?>"></td>
                        ...
                        <?php if ($invoice->invoice_balance == 0) { echo '<span class="stamp rotate bottom paid"
                            >' . trans('paid') . '</span
                        >'; } elseif ($is_overdue) { echo '<span class="stamp rotate bottom overdue"
                            >' . trans('overdue') . '</span
                        >'; } ?>
                    </div>
                    <!-- .invoice-items -->
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div>
                                        ...
                                        <?php _htmlsc(parse_template($invoice, $invoice->user_remittance_text ?:
                                        get_setting('qr_code_remittance_text'))); ?>
                                    </div>
                                </td>
                                <td class="amount"><?php echo invoice_qrcode($invoice->invoice_id); ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <hr />
                    ...
                    <div class="row">
                        ...
                        <?php } ?> <?php if (count($attachments) > 0) { ?>
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-condensed">
                                    ...
                                    <tr class="attachments">
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo site_url('guest/get/get_file/' . $attachment['fullname']); ?>"
