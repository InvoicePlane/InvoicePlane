...
<div style="border:1px solid #990000;padding-left:20px;margin:0 0 10px 0;">
    ...
    <h4><?php echo error_trans('error_exception_encountered'); ?></h4>

    <p><?php echo error_trans('error_type'); ?>: <?php echo get_class($exception); ?></p>
    <p><?php echo error_trans('error_message'); ?>: <?php echo $message; ?></p>
    <p><?php echo error_trans('error_filename'); ?>: <?php echo $exception->getFile(); ?></p>
    <p><?php echo error_trans('error_line_number'); ?>: <?php echo $exception->getLine(); ?></p>
<?php
